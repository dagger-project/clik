defmodule Clik.ConfigurationTest do
  ...
  describe "registering commands" do
    test "empty configuration" do
      ...
      assert 0 == Enum.count(config.global_options)
  ...
  describe "options" do
    ...
    test "retrieve options for unknown command" do
      assert {:error, :unknown_command} == Configuration.options(%Configuration{}, :hello)
      assert_raise UnknownCommandError, fn -> Configuration.options!(%Configuration{}, :hello) end
    end
    ...
    test "prepare global options for parsing" do
      ...
      assert {:ok, [strict: [help: :boolean, dry_run: :boolean], aliases: [d: :dry_run]]} ==
    ...
    test "prepare options for unknown command" do
      assert {:error, :unknown_command} == Configuration.prepare(%Configuration{}, :hello)
    end
  end
end
